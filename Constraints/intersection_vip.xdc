...
## Slide Switch
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { vip_slide[1] }]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { vip_slide[0] }]
