...
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports isvip]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports isnight]
...
## Slide Switch
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { vip_slide[1] }]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { vip_slide[0] }]

set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { tr_slide[1] }]
set_property -dict { PACKAGE_PIN H6   IOSTANDARD LVCMOS33 } [get_ports { tr_slide[0] }]
